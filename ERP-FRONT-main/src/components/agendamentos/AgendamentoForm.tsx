...
import {
  AgendamentoSchema,
  TAgendamentoSchema,
} from "@/lib/validators/agendamentoValidator";
...
export default function AgendamentoForm({
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: (data: TAgendamentoSchema) =>
      initialData?._id
        ? api.put(`/agendamentos/${initialData._id}`, data)
        : api.post("/agendamentos", data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["agendamentos"] });
      alert(
        initialData?._id ? "Agendamento atualizado!" : "Agendamento salvo!"
      );
      onSuccess();
    },
