    ...
    <div className="p-6 md:p-8 lg:p-10 min-h-screen">
      ...
      <main className="grid gap-8 md:grid-cols-3">
        ...
        <div className="md:col-span-1">
          <Card>
            <CardHeader>
              <CardTitle className=''>Saldo Atual</CardTitle>
        ...
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle className=''>Histórico de Transações</CardTitle>
                  ...
                  {isLoading ? (
                    ...
                    data.transacoes.map((transacao) => (
                      <TableRow key={transacao._id}>
                        ...
                        <TableCell className=''>{new Date(transacao.data).toLocaleDateString('pt-BR')}</TableCell>
